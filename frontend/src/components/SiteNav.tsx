...
export type SiteNavPage = 'home' | 'series' | 'library' | 'about';
 ...
 * Highlights) renders this same component so the link set can no longer
 * drift page-to-page — each page used to hand-copy this markup and quietly
 * diverge (missing Exams/Admin on some pages, a different set on others).
 *
